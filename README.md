...
Q : The thing is that the contents of each tab (their screens) are actually in One big page, when scrolling down the page and it reaches the contents of Tab2 ? 

A : This is demo showen how you can use scroll view to change tabs on scroll end. 

Bug : This demo have an issue that first time it's work without any issue but after you have to reset the scroll view to top.
